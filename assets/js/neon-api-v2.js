const NEON_REST_URL = 'https://sml-api.onrender.com';
...
document.addEventListener("DOMContentLoaded", carregarProjetosNoSite);
window.addEventListener("load", carregarProjetosNoSite);
