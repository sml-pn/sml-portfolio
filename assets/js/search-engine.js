var SMLEngine = (function() {
  ...
  function buildFromPage() {
    ...
    // SERVIÇOS DE E-MAIL
    docs.push({ id:'email_gmail', keywords:'email compartilhado gmail compartilhado email gratuito email para equipe conta gmail compartilhada email para funcionarios', resposta:'📧 <b>Gmail Compartilhado — R$ 80,00</b> (configuração única)<br><br>✅ Uma conta Gmail para toda a equipe<br>✅ Cada funcionário cria sua própria assinatura<br>✅ Configurado em 2 dias úteis<br>✅ Sem custo mensal<br><br>⚠️ Senha compartilhada (menos seguro)<br>⚠️ E-mail @gmail.com (menos profissional)<br><br>💡 Ideal para começar. Depois pode migrar para Google Workspace.' + wppBtn('Quero configurar!') });
    docs.push({ id:'email_workspace', keywords:'google workspace email profissional email com dominio proprio email corporativo workspace gmail empresarial email dominio', resposta:'📧 <b>Google Workspace (E-mail Profissional) — R$ 300,00</b> (configuração única)<br><br>✅ E-mail com seu domínio (ex: contato@seunegocio.com.br)<br>✅ Até 6 contas individuais com senhas próprias<br>✅ Calendário, Drive e Meet compartilhados<br>✅ Segurança e auditoria<br>⏱️ Configurado em 3 dias úteis<br><br>⚠️ Requer domínio próprio (.com.br ou .com)<br>⚠️ Custo mensal do Google Workspace (a partir de R$ 32,72/usuário/mês)' + wppBtn('Quero Google Workspace!') });

    // INTENÇÕES DO KNOWLEDGE.JSON QUE FALTAVAM
    docs.push({ id:'precos_geral', keywords:'quanto custa preco valores tabela de precos orcamento investimento custa taxa cobrar', resposta:'📋 Preços SML/PN (pagamento único):\n\n📱 Vitrine Bio:\n🟢 Simples: R$ 97,90 (72h)\n🔵 Premium: R$ 247,90 (5-7 dias) ⭐\n🟣 Empresarial: R$ 497,90 (5-7 dias)\n\n🌐 Sites (Hospedagem Render inclusa):\n🎯 Landing Page: R$ 547,90 (5 dias)\n📄 Site 2 Páginas: R$ 697,90 (6 dias)\n🏢 Institucional: R$ 997,90 (9 dias)\n🛒 E-commerce: sob consulta\n🤖 Chat RAG: R$ 197,90\n\n📧 E-mail: Gmail Compartilhado R$ 80,00 | Google Workspace R$ 300,00\n🌐 Domínio próprio: + R$ 83,90 (configuração DNS)\n\n✅ Garantia 7 dias • 50% início + 50% entrega' + wppBtn('Quero contratar!') });
    ...
    docs.push({ id:'landing_dominio', keywords:'landing page com dominio landing com dominio proprio pagina com dominio site com dominio quanto custa landing com dominio landing page dominio', resposta:'🎯 Landing Page + Domínio Próprio: R$ 631,90\n\n📱 Landing Page: R$ 547,90 (5 dias úteis)\n🌐 Configuração de domínio: R$ 83,90\n\n✅ Total: R$ 631,90\n\nO domínio (.com.br, .com) você compra onde preferir (HostGator, Registro.br) e eu configuro o DNS.' + wppBtn('Quero Landing Page com domínio!') });
    docs.push({ id:'site2_dominio', keywords:'site 2 paginas com dominio duas paginas com dominio proprio site duas paginas dominio', resposta:'📄 Site 2 Páginas + Domínio Próprio: R$ 781,90\n\n📄 Site 2 páginas: R$ 697,90 (6 dias úteis)\n🌐 Configuração de domínio: R$ 83,90\n\n✅ Total: R$ 781,90\n\nO domínio (.com.br, .com) você compra onde preferir e eu configuro o DNS.' + wppBtn('Quero Site 2 páginas com domínio!') });
  }
