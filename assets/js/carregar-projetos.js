document.addEventListener('DOMContentLoaded', () => {
  ...
  // Projetos cadastrados diretamente no código
  const projetos = [
    {
      icone: "smartphone",
      titulo: "BIOS",
    ...
    },
    {
      icone: "shopping-cart",
      titulo: "Amei Cetim",
      descricao: "Landing page desenvolvida para a Amei Cetim, marca especializada em acessórios de cetim premium para autocuidado. O site foi projetado com foco em elegância visual, experiência de compra intuitiva e total responsividade, integrando carrinho inteligente com finalização direta via WhatsApp e otimização para compartilhamento em redes sociais.",
      tecnologias: "HTML5, Tailwind CSS, JavaScript, Font Awesome, Google Fonts, Pillow (Python)",
      link: "",
      gradient: "from-neon to-neon-pink",
      bg_tag: "bg-neon/20",
      categoria: "Ecommerce",
    ...
    {
      icone: "box",
      titulo: "Halison Henry Portfólio",
      descricao: "Landing page desenvolvida para o gestor de tráfego Halison Henry, especialista em lançamentos e vendas perpétuas de infoprodutos. O site foi projetado com foco em alta conversão, design futurista e total responsividade.",
      tecnologias: "HTML5, CSS3, JavaScript, Font Awesome 6.5.1, Google Fonts, Google Analytics 4, Google Search Console, Banner LGPD",
      link: "https://halison-henry.onrender.com/",
      gradient: "from-neon to-neon-pink",
      bg_tag: "bg-neon/20",
      categoria: "Marketing",
      tipo: "icone",
